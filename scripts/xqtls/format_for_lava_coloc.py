...
for dataset in datasets:
    ...
    infile = os.path.join(qtl_dir, qtl_type, dataset_origin, "full_sumstat", qtl_type + "_" + dataset_origin + "_" + tissue + ".chr" + chrom + ".txt.gz") #TODO: modify the path to have the same naming convention
