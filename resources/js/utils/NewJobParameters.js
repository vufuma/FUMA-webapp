...
export const CheckAll = function() {
  ...
  // refSNPs is always OK [5]
	...
	if(tablecheck==false){
		$('#NewJobPosMapPanel').siblings(".card-header").attr("class", "card-header input bg-danger text-white");
	}else{
		$('#NewJobPosMapPanel').siblings(".card-header").attr("class", "card-header input bg-light");
	}
	...
	if(tablecheck==false){
		$('#NewJobEqtlMapPanel').siblings(".card-header").attr("class", "card-header input bg-danger text-white");
	}else{
		$('#NewJobEqtlMapPanel').siblings(".card-header").attr("class", "card-header input bg-light");
	}
	...
	if(tablecheck==false){
		$('#NewJobCiMapPanel').siblings(".card-header").attr("class", "card-header input bg-danger text-white");
	}else{
		$('#NewJobCiMapPanel').siblings(".card-header").attr("class", "card-header input bg-light");
	}
