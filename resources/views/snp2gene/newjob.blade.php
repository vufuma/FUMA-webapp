		...
		<div class="col-4">
			<span class="form-inline" style="font-size:18px;">
				Use your previous settings from job&nbsp;<a class="infoPop" data-bs-toggle="popover"
					title="Previous jobID" data-bs-content="By selecting jobID of your existing SNP2GENE jobs,
				...
				<div class="accordion-body">
					...
					<table class="table table-bordered inputTable" id="NewJobFiles" style="width: auto;">
						<tr>
							...
							<td><input type="file" class="form-control-file" name="GWASsummary" id="GWASsummary" /><br>
					...
					<tr class="eqtlMapOptions">
						...
						<td>
							...
							<div class="input-group mt-1">
								...
								<input type="number" class="form-control" name="eqtlP" id="eqtlP" value="1e-3"
									onchange="window.CheckAll();">
							</div>
						</td>
						<td></td>
				...
				<div id="eqtlMapOptFilt">
					...
					<table class="table table-bordered inputTable" id="eqtlMapOptFiltTable">
						...
						<tr>
							...
							<td><input type="number" class="form-control" id="eqtlMapChr15Max" name="eqtlMapChr15Max"
									value="7" onkeyup="window.CheckAll();" onpaste="window.CheckAll();"
									oninput="window.CheckAll();" /></td>
							<td></td>
						</tr>
					...
					<tr class="ciMapOptions">
						...
						<td>
							<span class="multiSelect">
								<a class="clear" style="float:right; padding-right:20px;">Clear</a>
								<a class="all" style="float:right; padding-right:20px;">Select all</a><br>
								<select multiple class="form-select" id="ciMapBuiltin" name="ciMapBuiltin[]" size="10"
									onchange="window.CheckAll();">
					...
					<tr class="ciMapOptions">
						...
						<td>
							<div class="input-group">
								...
								<input type="number" class="form-control" name="ciMapFDR" id="ciMapFDR" value="1e-6"
									onchange="window.CheckAll();">
							</div>
						</td>
						<td></td>
					...
					<tr class="ciMapOptions">
						...
						<td>
							<span class="multiSelect">
								<a class="clear" style="float:right; padding-right:20px;">Clear</a>
								<a class="all" style="float:right; padding-right:20px;">Select all</a><br>
								<select multiple class="form-select" id="ciMapRoadmap" name="ciMapRoadmap[]" size="10"
									onchange="window.CheckAll();">
				...
				<div id="ciMapOptFilt">
					...
					<table class="table table-bordered inputTable" id="ciMapOptFiltTable">
						...
						<tr>
							...
							<td><input type="checkbox" class="form-check" name="ciMapChr15check" id="ciMapChr15check"
									onchange="window.CheckAll();"></td>
							<td></td>
						</tr>
						<tr>
			...
			<div class="accordion-body">
				<table class="table table-bordered inputTable" id="NewJobMHC" style="width: auto;">
					<tr>
						...
						<td>
							<div class="input-group">
								<input type="checkbox" class="form-check-inline" name="MHCregion" id="MHCregion" value="exMHC"
									checked onchange="window.CheckAll();">
								<select class="form-select" id="MHCopt" name="MHCopt" onchange="window.CheckAll();">
