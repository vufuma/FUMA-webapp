	...
	<div class="accordion" style="padding-top: 0px;">
		<div class="accordion-item">
			<h2 class="accordion-header" id="heading1">
				<button class="accordion-button fs-4" type="button" data-bs-target="#NewJobFilesPanel"
					...
					<table class="table table-bordered inputTable" id="NewJobFiles" style="width: auto;">
						<tr>
							...
							<td><input type="file" class="form-control-file" name="GWASsummary" id="GWASsummary" />
								Or <input type="checkbox" class="form-check-inline" name="egGWAS" id="egGWAS"
									onchange="window.CheckAll()" />: Use example input (Crohn's disease, Franke et
								al. 2010).
							</td>
							<td></td>
						</tr>
						<tr>
							<td>GWAS summary statistics file columns
								<a class="infoPop" data-bs-toggle="popover"
									title="GWAS summary statistics input file columns" data-bs-content="This is optional parameter to define column names.
							...
							<td>
								...
								<span class="inputSpan">Chromosome: <input type="text" class="form-control" id="chrcol"
										name="chrcol"></span>
								<span class="inputSpan">Position: <input type="text" class="form-control" id="poscol"
										name="poscol"></span>
								<span class="inputSpan">rsID: <input type="text" class="form-control" id="rsIDcol"
										name="rsIDcol"></span>
								<span class="inputSpan">P-value: <input type="text" class="form-control" id="pcol"
										name="pcol"></span>
								...
								<span class="inputSpan">Beta: <input type="text" class="form-control" id="becol"
										name="becol"></span>
								<span class="inputSpan">SE: <input type="text" class="form-control" id="secol"
										name="secol"></span>
							</td>
							<td>
						...
						<tr>
							...
							<td><input type="checkbox" class="form-check-inline" name="GRCh38" id="GRCh38" value="1"
									unchecked disabled></td>
						...
						<tr>
							<td>Identify additional independent lead SNPs
								<a class="infoPop" data-bs-toggle="popover" title="Additional identification of lead SNPs"
		...
		<div class="accordion-item" style="padding:0px;">
			<h2 class="accordion-header" id="heading2">
				<button class="accordion-button fs-4" type="button" data-bs-target="#NewJobParamsPanel"
					...
					<table class="table table-bordered inputTable" id="NewJobParams" style="width: auto;">
						<tr>
							...
							<td>
								...
								OR<br>
								Column name for N per SNP (text): <input type="text" class="form-control" id="Ncol"
									name="Ncol" onkeyup="window.CheckAll();" onpaste="window.CheckAll();"
									oninput="window.CheckAll();">
							</td>
							<td></td>
						</tr>
						<tr>
							...
							<td><input type="number" class="form-control" id="leadP" name="leadP" value="5e-8"
									onkeyup="window.CheckAll();" onpaste="window.CheckAll();"
						...
						<tr>
							...
							<td><input type="number" class="form-control" id="gwasP" name="gwasP" value="0.05"
									onkeyup="window.CheckAll();" onpaste="window.CheckAll();"
									oninput="window.CheckAll();" /></td>
							<td></td>
						</tr>
						<tr>
							...
							<td><input type="number" class="form-control" id="r2" name="r2" value="0.6"
									onkeyup="window.CheckAll();" onpaste="window.CheckAll();"
									oninput="window.CheckAll();"></td>
							<td></td>
						</tr>
						<tr>
							<td>2nd r<sup>2</sup> threshold to define lead SNPs (&ge;)
								<a class="infoPop" data-bs-toggle="popover" title="2nd r2 threshold" data-bs-content="This is a r2 threshold for second clumping to define lead SNPs from independent significant SNPs.
								When this value is same as 1st r2 threshold, lead SNPs are identical to independent significant SNPs.">
									<i class="fa-regular fa-circle-question fa-lg"></i>
								</a>
							</td>
							<td><input type="number" class="form-control" id="r2_2" name="r2_2" value="0.1"
									onkeyup="window.CheckAll();" onpaste="window.CheckAll();"
									oninput="window.CheckAll();"></td>
							<td></td>
						</tr>
						...
						<tr>
							<td>Include variants in reference panel (non-GWAS tagged SNPs in LD)
								<a class="infoPop" data-bs-toggle="popover" title="Variants in reference" data-bs-content="Select ‘yes’
						...
						<tr>
							...
							<td><input type="number" class="form-control" id="maf" name="maf" value="0"
									onkeyup="window.CheckAll();" onpaste="window.CheckAll();"
									oninput="window.CheckAll();" /></td>
							<td></td>
						</tr>
		...
		<div class="accordion-item" style="padding:0px;">
			<h2 class="accordion-header" id="heading31">
				<button class="accordion-button fs-4 collapsed" type="button" data-bs-target="#NewJobPosMapPanel"
		...
		<div class="accordion-item" style="padding:0px;">
			<h2 class="accordion-header" id="heading32">
				<button class="accordion-button fs-4 collapsed " type="button" data-bs-target="#NewJobEqtlMapPanel"
						...
						<tr class="eqtlMapOptions">
							...
							<td>
								<span class="form-inline">Use only significant snp-gene pairs: <input type="checkbox"
										...
										onchange="window.CheckAll();"> (FDR&lt;0.05)</span><br>
								OR<br>
		...
		<div class="accordion-item" style="padding: 0px;">
			<h2 class="accordion-header" id="heading33">
				<button class="accordion-button fs-4 collapsed" type="button" data-bs-target="#NewJobCiMapPanel"
				...
				<div class="accordion-body">
					...
					<table class="table table-bordered inputTable" id="NewJobCiMap" style="width: auto;">
						...
						<tr class="ciMapOptions">
							...
							<td>
								<span class="form-inline">FDR cutoff (&lt;): <input type="number" class="form-control"
										name="ciMapFDR" id="ciMapFDR" value="1e-6" onchange="window.CheckAll();"></span>
							</td>
							<td></td>
						</tr>
						<tr class="ciMapOptions">
						...
						<tr class="ciMapOptions">
							...
							<td><input type="checkbox" class="form-control" name="ciMapEnhFilt" id="ciMapEnhFilt"
									onchange="window.CheckAll();"></td>
							<td></td>
						</tr>
						<tr class="ciMapOptions">
							...
							<td><input type="checkbox" class="form-control" name="ciMapPromFilt" id="ciMapPromFilt"
									onchange="window.CheckAll();"></td>
							<td></td>
						</tr>
						<!-- </div> -->
					...
					<div id="ciMapOptFilt">
						...
						<table class="table table-bordered inputTable" id="ciMapOptFiltTable">
							<tr>
								...
								<td><input type="checkbox" class="form-check-inline" name="ciMapCADDcheck"
										id="ciMapCADDcheck" onchange="window.CheckAll();"></td>
								<td></td>
							</tr>
							<tr>
								<td>Minimum CADD score (&ge;)
							...
							<tr>
								...
								<td><input type="checkbox" class="form-check-inline" name="ciMapRDBcheck"
										id="ciMapRDBcheck" onchange="window.CheckAll();"></td>
								<td></td>
							</tr>
							<tr>
								<td>Maximum RegulomeDB score (categorical)
							...
							<tr>
								...
								<td><input type="checkbox" class="form-check-inline" name="ciMapChr15check"
		...
		<div class="accordion-item" style="padding:0px;">
			<h2 class="accordion-header" id="headingGT">
				<button class="accordion-button fs-4 collapsed" type="button" data-bs-target="#NewJobGenePanel"
		...
		<div class="accordion-item" style="padding:0px;">
			<h2 class="accordion-header" id="headingMHC">
				<button class="accordion-button fs-4 collapsed" type="button" data-bs-target="#NewJobMHCPanel"
		...
		<div class="accordion-item" style="padding:0px;">
			<h2 class="accordion-header" id="headingMAG">
				<button class="accordion-button fs-4 collapsed" type="button" data-bs-target="#NewJobMAGMAPanel"
				...
				<div class="accordion-body">
					<table class="table table-bordered inputTable" id="NewJobMAGMA" style="width: auto;">
						<tr>
							...
							<td>
								<span class="form-inline">
									<input type="checkbox" class="form-check-inline" name="magma" id="magma"
										onchange="window.CheckAll();">
								</span>
							</td>
							<td></td>
						...
						<tr>
							<td>Gene windows
								<a class="infoPop" data-bs-toggle="popover" title="MAGMA gene window" data-bs-content="The window size of genes to assign SNPs.
