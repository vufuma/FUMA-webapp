<div id="newJob" class="sidePanel container" style="padding-top:50px;">
	...
	<!-- New -->
	<h5 style="color: #00004d">Upload your GWAS summary statistics and set parameters to obtain functional annotations of the genomic loci associated with your trait.</h4>
			...
			<table class="table table-bordered inputTable" id="NewJobFiles" style="width: auto;">
				<tr>
					...
					<td><input type="file" class="form-control-file" name="GWASsummary" id="GWASsummary"/>
						Or <input type="checkbox" class="form-check-inline" name="egGWAS" id="egGWAS" onchange="window.CheckAll()"/>: Use example input (Crohn's disease, Franke et al. 2010).
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Input is build GRCh38
						<a class="infoPop" data-toggle="popover" title="GRCh38 Input" data-content="The input file has chromosome and position columns on build GRCh38. The column names for the chromosome, position, effect allele, and non-effect allele must be specified above.">
							<i class="fa-regular fa-circle-question fa-lg"></i>
						</a>
					</td>
					<td><input type="checkbox" class="form-check-inline" name="GRCh38" id="GRCh38" value="1" unchecked disabled></td>
					{{-- <td><input type="checkbox" class="form-check-inline" name="GRCh38" id="GRCh38" value="1" unchecked onchange="window.CheckAll()"></td> --}}
					<td></td>
				</tr>
				<tr>
					...
					<td><input type="file" class="form-control-file" name="leadSNPs" id="leadSNPs" onchange="window.CheckAll()"/></td>
					<td></td>
				</tr>
				<tr>
					...
					<td><input type="checkbox" class="form-check-inline" name="addleadSNPs" id="addleadSNPs" value="1" checked onchange="window.CheckAll()"></td>
					<td></td>
				</tr>
				<tr>
					...
					<td><input type="file" class="form-control-file" name="regions" id="regions" onchange="window.CheckAll()"/></td>
					<td></td>
				</tr>
			</table>
		</div>
		...
		<div class="card-body collapse in" id="NewJobParamsPanel">
			<table class="table table-bordered inputTable" id="NewJobParams" style="width: auto;">
				...
				<tr>
					...
					<td><input type="number" class="form-control" id="leadP" name="leadP" value="5e-8" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"/></td>
					<td></td>
				</tr>
				<tr>
					...
					<td><input type="number" class="form-control" id="gwasP" name="gwasP" value="0.05" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"/></td>
					<td></td>
				</tr>
				<tr>
					<td>r<sup>2</sup> threshold to define independent significant SNPs (&ge;)</td>
					<td><input type="number" class="form-control" id="r2" name="r2" value="0.6" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"></td>
					<td></td>
				</tr>
				<tr>
					...
					<td><input type="number" class="form-control" id="r2_2" name="r2_2" value="0.1" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"></td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="number" class="form-control" id="maf" name="maf" value="0" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"/></td>
					<td></td>
				</tr>
				<tr>
					...
					<td><span class="form-inline"><input type="number" class="form-control" id="mergeDist" name="mergeDist" value="250" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"/> kb</span></td>
					<td></td>
				</tr>
			</table>
		</div>
		...
		<div class="card-body collapse" id="NewJobPosMapPanel">
			...
			<table class="table table-bordered inputTable" id="NewJobPosMap" style="width: auto;">
				<tr>
					...
					<td><input type="checkbox" class="form-check-inline" name="posMap" id="posMap" checked onchange="window.CheckAll();"></td>
					<td></td>
				</tr>
			...
			<div id="posMapOptFilt">
				...
				<table class="table table-bordered inputTable" id="posMapOptFiltTable" style="width: auto;">
					<tr>
						...
						<td><input type="checkbox" class="form-check-inline" name="posMapCADDcheck" id="posMapCADDcheck" onchange="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
						...
						<td><input type="number" class="form-control" id="posMapCADDth" name="posMapCADDth" value="12.37" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
						...
						<td><input type="checkbox" class="form-check-inline" name="posMapRDBcheck" id="posMapRDBcheck" onchange="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							...
							<select class="form-control" id="posMapRDBth" name="posMapRDBth" onchange="window.CheckAll();">
								<option>1a</option>
								<option>1b</option>
								<option>1c</option>
								<option>1d</option>
					...
					<tr>
						...
						<td><input type="checkbox" class="form-check-inline" name="posMapChr15check" id="posMapChr15check" onchange="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="number" class="form-control" id="posMapChr15Max" name="posMapChr15Max" value="7" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"/></td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<select  class="form-control" id="posMapChr15Meth" name="posMapChr15Meth" onchange="window.CheckAll();">
		...
		<div class="card-body collapse" id="NewJobEqtlMapPanel">
			...
			<table class="table table-bordered inputTable" id="NewJobEqtlMap" style="width: auto;">
				<tr>
					...
					<td><input type="checkbox" calss="form-control" name="eqtlMap", id="eqtlMap" onchange="window.CheckAll();"></td>
					<td></td>
				</tr>
			...
			<div id="eqtlMapOptFilt">
				...
				<table class="table table-bordered inputTable" id="eqtlMapOptFiltTable">
					<tr>
						...
						<td><input type="checkbox" class="form-check-inline" name="eqtlMapCADDcheck" id="eqtlMapCADDcheck" onchange="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
						<td>Minimum CADD score (&ge;)
						...
						<td><input type="number" class="form-control" id="eqtlMapCADDth" name="eqtlMapCADDth" value="12.37" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
						<td rowspan="2">RegulomeDB</td>
						...
						<td><input type="checkbox" class="form-check-inline" name="eqtlMapRDBcheck" id="eqtlMapRDBcheck" onchange="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
						<td>Maximum RegulomeDB score (categorical)
						...
						<td>
							...
							<select class="form-control" id="eqtlMapRDBth" name="eqtlMapRDBth" onchange="window.CheckAll();">
								<option>1a</option>
								<option>1b</option>
								<option>1c</option>
								<option>1d</option>
					...
					<tr>
						...
						<td><input type="checkbox" class="form-check-inline" name="eqtlMapChr15check" id="eqtlMapChr15check" onchange="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
						<td>Tissue/cell types for 15-core chromatin state<br>
					...
					<tr>
						...
						<td><input type="number" class="form-control" id="eqtlMapChr15Max" name="eqtlMapChr15Max" value="7" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"/></td>
						<td></td>
					</tr>
					<tr>
						<td>15-core chromatin state filtering method
						...
						<td>
							<select  class="form-control" id="eqtlMapChr15Meth" name="eqtlMapChr15Meth" onchange="window.CheckAll();">
								<option selected value="any">any</option>
								<option value="majority">majority</option>
								<option value="all">all</option>
							</select>
		...
		<div class="card-body collapse" id="NewJobCiMapPanel">
			...
			<table class="table table-bordered inputTable" id="NewJobCiMap" style="width: auto;">
				<tr>
					...
					<td><input type="checkbox" calss="form-control" name="ciMap", id="ciMap" onchange="window.CheckAll();"></td>
					<td></td>
				</tr>
				...
				<tr class="ciMapOptions">
					...
					<td>
						<span class="form-inline">FDR cutoff (&lt;): <input type="number" class="form-control" name="ciMapFDR" id="ciMapFDR" value="1e-6" onchange="window.CheckAll();"></span>
					</td>
					<td></td>
				</tr>
				<tr class="ciMapOptions">
					...
					<td><input type="text" class="form-control" name="ciMapPromWindow" id="ciMapPromWindow" value="250-500" onchange="window.CheckAll();">
						<span class="info"><i class="fa fa-info"></i>
				...
				<tr class="ciMapOptions">
					...
					<td><input type="checkbox" calss="form-control" name="ciMapEnhFilt", id="ciMapEnhFilt" onchange="window.CheckAll();"></td>
					<td></td>
				</tr>
				<tr class="ciMapOptions">
					...
					<td><input type="checkbox" calss="form-control" name="ciMapPromFilt", id="ciMapPromFilt" onchange="window.CheckAll();"></td>
					<td></td>
				</tr>
				<!-- </div> -->
			</table>
			...
			<div id="ciMapOptFilt">
				...
				<table class="table table-bordered inputTable" id="ciMapOptFiltTable">
					<tr>
						...
						<td><input type="checkbox" class="form-check-inline" name="ciMapCADDcheck" id="ciMapCADDcheck" onchange="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
						<td>Minimum CADD score (&ge;)
						...
						<td><input type="number" class="form-control" id="ciMapCADDth" name="ciMapCADDth" value="12.37" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
						<td rowspan="2">RegulomeDB</td>
						...
						<td><input type="checkbox" class="form-check-inline" name="ciMapRDBcheck" id="ciMapRDBcheck" onchange="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
						<td>Maximum RegulomeDB score (categorical)
						...
						<td>
							<select class="form-control" id="ciMapRDBth" name="ciMapRDBth" onchange="window.CheckAll();">
								<option>1a</option>
								<option>1b</option>
								<option>1c</option>
								<option>1d</option>
					...
					<tr>
						...
						<td><input type="checkbox" class="form-check-inline" name="ciMapChr15check" id="ciMapChr15check" onchange="window.CheckAll();"></td>
						<td></td>
					</tr>
					<tr>
						<td>Tissue/cell types for 15-core chromatin state<br>
					...
					<tr>
						...
						<td><input type="number" class="form-control" id="ciMapChr15Max" name="ciMapChr15Max" value="7" onkeyup="window.CheckAll();" onpaste="window.CheckAll();" oninput="window.CheckAll();"/></td>
						<td></td>
					</tr>
					<tr>
						<td>15-core chromatin state filtering method
						...
						<td>
							<select  class="form-control" id="ciMapChr15Meth" name="ciMapChr15Meth" onchange="window.CheckAll();">
								<option selected value="any">any</option>
								<option value="majority">majority</option>
								<option value="all">all</option>
							</select>
		...
		<div class="card-body collapse" id="NewJobGenePanel">
			<table class="table table-bordered inputTable" id="NewJobGene" style="width: auto;">
				...
				<tr>
					...
					<td>
						<select multiple class="form-control" name="genetype[]" id="genetype" onchange="window.CheckAll();">
							<option value="all">All</option>
				...
				<tr>
					...
					<td>
						<span class="form-inline">
							<input type="checkbox" class="form-check-inline" name="MHCregion" id="MHCregion" value="exMHC" checked onchange="window.CheckAll();">
							<select class="form-control" id="MHCopt" name="MHCopt" onchange="window.CheckAll();">
		...
		<div class="card-body collapse" id="NewJobMAGMAPanel">
			<table class="table table-bordered inputTable" id="NewJobMAGMA" style="width: auto;">
				<tr>
					...
					<td>
						<span class="form-inline">
							<input type="checkbox" class="form-check-inline" name="magma" id="magma" onchange="window.CheckAll();">
						</span>
					</td>
					<td></td>
				</tr>
