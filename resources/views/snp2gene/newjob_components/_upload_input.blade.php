                        ...
                        <td><input type="file" class="form-control-file" name="GWASsummary"
                            ...
                            <div class="form-check"> <input type="checkbox" class="form-check-input"
                                ...
                                <span class="info"><i class="fa fa-info fa-sm"></i>
                                    The default of this option is unchecked, which means that your GWAS summary statistics and related files will be deleted once the SNP2GENE process is finished. <br>
                                    If this option is checked, you are consenting to keeping your GWAS summary statistics input files and related files that are generated by FUMA in order to run FLAMES. Due to storage cost, these files will be kept a maximum of one week to allow you to run FLAMES. After the one week period, they will be deleted. 
                                </span>
                            </div>
                        </td>
                        <td></td>
