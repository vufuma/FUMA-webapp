                        ...
                        <td><input type="file" class="form-control-file" name="GWASsummary"
                            ...
                            <div class="form-check"> <input type="checkbox" class="form-check-input"
                                ...
                                <span class="info"><i class="fa fa-info fa-sm"></i>
                                    If you check this option, you need to make sure that your file has these columns: either (1) a file with 3 columns and headers in this exact order: chromosome, base_pair_location, p_value or (2) a file with 6 columns and headers in this exact order: chromosome, base_pair_location, effect_allele, other_allele, beta, p_value. Otherwise, your job will fail. <br>
                                </span>
                            </div>
                            <br>
                            ...
                            <div class="form-check"> <input type="checkbox" class="form-check-input"
                                ...
                                <span class="info"><i class="fa fa-info fa-sm"></i>
                                    ...
                                    If this option is checked, you are consenting to keeping your GWAS summary statistics and intermediate files that are generated by FUMA in order to run FLAMES. These files will be kept a maximum of one week to allow you to run FLAMES. After the one week period, they will be deleted permanently. <br>
                                    <strong>Please only check this option ONLY IF you want to run FLAMES afterwards.</strong><br>
                                    <strong>Please check the <a href="https://fuma-docs.readthedocs.io/en/latest/flames/quick_start.html#submit-a-snp2gene-job" target="_blank"> documentation </a> for how to prepare the input file</strong> 
                                </span>
                            </div>
                        </td>
                        <td></td>
