                        ...
                        <td><input type="file" class="form-control-file" name="GWASsummary"
                            ...
                            <div class="form-check"> <input type="checkbox" class="form-check-input"
                                ...
                                <span class="info"><i class="fa fa-info fa-sm"></i>
                                    ...
                                    <strong>If you want to run FLAMES afterwards, please check the <a href="https://fuma-docs.readthedocs.io/en/latest/flames/quick_start.html#submit-a-snp2gene-job" target="_blank"> documentation </a> for how to prepare the input file</strong> 
                                </span>
                            </div>
                        </td>
                        <td></td>
