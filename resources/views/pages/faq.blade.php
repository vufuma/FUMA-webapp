	...
	<div style="padding-top: 50px; padding-right: 50px; padding-left: 50px;">
		<div class="card mb-2">
			<div class="card-header faq">
				<h5>My job returned: ERROR: 001 (Input file format not correct). What should I do? <a href="#faq1" data-bs-toggle="collapse" class="active" style="float: right; padding-right:20px;"><i class="fa fa-chevron-up"></i></a></h4>
			</div>
		...
		<div class="card mb-2">
			<div class="card-header faq">
				<h5>My job returned: ERROR: 001 (Input file format was not correct/ValueError: cannot convert float NaN to integer). What do I do? <a href="#faq2" data-bs-toggle="collapse" class="active" style="float: right; padding-right:20px;"><i class="fa fa-chevron-up"></i></a></h4>
			</div>
		...
		<div class="card mb-2">
			<div class="card-header faq">
				<h5>My job returned: ERROR: 001 (No variants remain after filtering). What should I do?<a href="#faq3" data-bs-toggle="collapse" class="active" style="float: right; padding-right:20px;"><i class="fa fa-chevron-up"></i></a></h4>
			</div>
		...
		<div class="card mb-2">
			<div class="card-header faq" style="padding-top:5px;padding-bottom:5px;">
				<h5>My job status shows “Job Failed”. What could cause this and how do I fix this?<a href="#faq4" data-bs-toggle="collapse" class="active" style="float: right; padding-right:20px;"><i class="fa fa-chevron-up"></i></a></h4>
			</div>
		...
		<div class="card mb-2">
			<div class="card-header faq" style="padding-top:5px;padding-bottom:5px;">
				<h5>How many jobs can I submit at once?<a href="#faq5" data-bs-toggle="collapse" class="active" style="float: right; padding-right:20px;"><i class="fa fa-chevron-up"></i></a></h4>
			</div>
