                        ...
                        <div class="card-body" style="padding-bottom: 10;">
                            ...
                            <div>
                                <select multiple="multiple" class="form-control" style="display: none;" id="cellDataSets"
                                    ...
                                    @include('celltype.celltype_options.largeIntestine_options')
                                    ...
                                    @include('celltype.celltype_options.others_options')
                                    ...
                                    @include('celltype.celltype_options.smallIntestine_options')
