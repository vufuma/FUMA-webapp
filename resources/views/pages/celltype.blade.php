...
<div id="wrapper" class="active">
    ...
    <div id="page-content-wrapper">
            ...
            <div id="newJob" class="sidePanel container" style="padding-top:50px;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-1">
                            <div class="col-sm-5">
                                ...
                                <a class="infoPop" data-bs-toggle="popover" title="Ensembl dene ID" data-bs-content="Please UNCHECK this option if you used different gene ID than Ensembl gene ID
                    ...
                    <div class="card-body" style="padding-bottom: 10;">
                        ...
                        <div>
                            <select multiple="multiple" class="form-control" style="display: none;" id="cellDataSets"
                                ...
                                <option value="MouseCellAtlas_Peripheral_Blood" data-section="Blood/Mouse" data-key="0">
                                ...
                                <option value="Allen_Human_LGN_level1" data-section="Brain/Human" data-key="0">
                                    Allen_Human_LGN_level1</option>
                                <option value="Allen_Human_LGN_level2" data-section="Brain/Human" data-key="1">
                                    Allen_Human_LGN_level2</option>
                                <option value="Allen_Human_MTG_level1" data-section="Brain/Human" data-key="2">
                                    Allen_Human_MTG_level1</option>
                                <option value="Allen_Human_MTG_level2" data-section="Brain/Human" data-key="3">
                                    Allen_Human_MTG_level2</option>
                                <option value="DroNc_Human_Hippocampus" data-section="Brain/Human" data-key="4">
                                    DroNc_Human_Hippocampus</option>
                                <option value="GSE104276_Human_Prefrontal_cortex_all_ages" data-section="Brain/Human"
                                    data-key="5">GSE104276_Human_Prefrontal_cortex_all_ages</option>
                                <option value="GSE104276_Human_Prefrontal_cortex_per_ages" data-section="Brain/Human"
                                    data-key="6">GSE104276_Human_Prefrontal_cortex_per_ages</option>
                                <option value="GSE67835_Human_Cortex" data-section="Brain/Human" data-key="7">
                                    GSE67835_Human_Cortex</option>
                                <option value="GSE67835_Human_Cortex_woFetal" data-section="Brain/Human" data-key="8">
                                    GSE67835_Human_Cortex_woFetal</option>
                                <option value="Linnarsson_GSE101601_Human_Temporal_cortex" data-section="Brain/Human"
                                    data-key="9">Linnarsson_GSE101601_Human_Temporal_cortex</option>
                                <option value="Linnarsson_GSE76381_Human_Midbrain" data-section="Brain/Human"
                                    data-key="10">Linnarsson_GSE76381_Human_Midbrain</option>
                                <option value="PsychENCODE_Developmental" data-section="Brain/Human" data-key="11">
                                    PsychENCODE_Developmental</option>
                                <option value="PsychENCODE_Adult" data-section="Brain/Human" data-key="12">
                                    PsychENCODE_Adult</option>
                                <option value="GSE168408_Human_Prefrontal_Cortex_level1_Fetal"
                                    data-section="Brain/Human" data-key="13">
                                    GSE168408_Human_Prefrontal_Cortex_level1_Fetal</option>
                                <option value="GSE168408_Human_Prefrontal_Cortex_level1_Neonatal"
                                    data-section="Brain/Human" data-key="14">
                                    GSE168408_Human_Prefrontal_Cortex_level1_Neonatal</option>
                                <option value="GSE168408_Human_Prefrontal_Cortex_level1_Infancy"
                                    data-section="Brain/Human" data-key="15">
                                    GSE168408_Human_Prefrontal_Cortex_level1_Infancy</option>
                                <option value="GSE168408_Human_Prefrontal_Cortex_level1_Childhood"
                                    data-section="Brain/Human" data-key="16">
                                ...
                                <option value="GSE87544_Mouse_Hypothalamus" data-section="Brain/Mouse" data-key="38">
                                ...
                                <option value="GSE93374_Mouse_Arc_ME_level1" data-section="Brain/Mouse" data-key="40">
                                    GSE93374_Mouse_Arc_ME_level1</option>
                                <option value="GSE93374_Mouse_Arc_ME_level2" data-section="Brain/Mouse" data-key="41">
                                    GSE93374_Mouse_Arc_ME_level2</option>
                                <option value="GSE93374_Mouse_Arc_ME_neurons" data-section="Brain/Mouse" data-key="42">
                                    GSE93374_Mouse_Arc_ME_neurons</option>
                                <option value="GSE98816_Mouse_Brain_Vascular" data-section="Brain/Mouse" data-key="43">
                                ...
                                <option value="Linnarsson_GSE74672_Mouse_Hypothalamus_level1" data-section="Brain/Mouse"
                                    data-key="52">
                                ...
                                <option value="TabulaMuris_FACS_Brain_Myeloid" data-section="Brain/Mouse" data-key="63">
                                ...
                                <option value="GSE97478_Mouse_Striatum_Cortex" data-section="Brain/Mouse" data-key="66">
                                ...
                                <option value="MouseCellAtlas_Mammary_Gland" data-section="Breast/Mouse" data-key="0">
                                    MouseCellAtlas_Mammary_Gland</option>
                                <option value="TabulaMuris_FACS_Mammary_Gland" data-section="Breast/Mouse" data-key="1">
                                    TabulaMuris_FACS_Mammary_Gland</option>
                                <option value="TabulaMuris_droplet_Mammary" data-section="Breast/Mouse" data-key="2">
                                ...
                                <option value="TabulaMuris_FACS_Diaphragm" data-section="Diaphram/Mouse" data-key="0">
                                ...
                                <option value="MouseCellAtlas_Neonatal_Heart" data-section="Heart/Mouse" data-key="0">
                                ...
                                <option value="TabulaMuris_droplet_Kidney" data-section="Kidney/Mouse" data-key="2">
                                ...
                                <option value="GSE99235_Mouse_Lung_Vascular" data-section="Lung/Mouse" data-key="0">
                                ...
                                <option value="TabulaMuris_FACS_Limb_Muscle" data-section="Muscle/Mouse" data-key="1">
                                    TabulaMuris_FACS_Limb_Muscle</option>
                                <option value="MouseCellAtlas_Neonatal_Muscle" data-section="Muscle/Mouse" data-key="2">
                                    MouseCellAtlas_Neonatal_Muscle</option>
                                <option value="TabulaMuris_droplet_Muscle" data-section="Muscle/Mouse" data-key="3">
                                ...
                                <option value="TabulaMuris_FACS_Pancreas" data-section="Pancreas/Mouse" data-key="2">
                                ...
                                <option value="MouseCellAtlas_Neonatal_Skin" data-section="Skin/Mouse" data-key="2">
                                ...
                                <option value="TabulaMuris_droplet_Spleen" data-section="Spleen/Mouse" data-key="2">
                                ...
                                <option value="MouseCellAtlas_Fetal_Stomache" data-section="Stomach/Mouse" data-key="0">
                                ...
                                <option value="TabulaMuris_droplet_Thymus" data-section="Thymus/Mouse" data-key="2">
                                ...
                                <option value="TabulaMuris_droplet_Tongue" data-section="Tongue/Mouse" data-key="1">
                                ...
                                <option value="TabulaMuris_droplet_Trachea" data-section="Trachea/Mouse" data-key="1">
                                ...
                                <option value="MouseCellAtlas_Neonatal_all" data-section="Other/Mouse" data-key="2">
                ...
                <div class="card mt-2">
                    <div class="card-body" style="padding-bottom: 10;">
                        ...
                        <a class="infoPop" data-bs-toggle="popover" data-bs-content="Step 2 in the workflow is per dataset conditional analysis.
                        ...
                        <a class="infoPop" data-bs-toggle="popover" data-bs-content="Step 3 in the workflow is cross-datasets conditional analysis.
        ...
        <script type="module">
            import { CheckAll } from "{{ Vite::appjs('utils/NewJobParameters.js') }}";
        window.CheckAll = CheckAll;
        import { CellTypeSetup } from "{{ Vite::appjs('utils/celltype.js') }}";
        import { CheckInput } from "{{ Vite::appjs('utils/celltype.js') }}";
        window.CheckInput = CheckInput;
        import { SidebarSetup } from "{{ Vite::appjs('utils/sidebar.js') }}";
        import { ImgDownDS, ImgDown, updatePerDatasetPlot } from "{{ Vite::appjs('utils/cell_results.js') }}";
