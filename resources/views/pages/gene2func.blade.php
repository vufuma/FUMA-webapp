                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-sm-1">
                                <select class="form-control" id="ensembl" name="ensembl">
                                    ...
                                    <option value="v110_userGen">v110_userGen</option>
                            ...
                            <div class="col-sm-4">
                                <span class="info"><i class="fa fa-info"></i>&nbsp;Select Ensembl version. v102 and v110 were added in June 2023. In FUMA version 2.1.8, v110_userGen was added. This version was generated by user Gunnar Korde by lifting over the coordinates for version 110 from GRCh38 to GRCh37.</span>
                            </div>
                        </div>
                        <div class="row mb-1">
